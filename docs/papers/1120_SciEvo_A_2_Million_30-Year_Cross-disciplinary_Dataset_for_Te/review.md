...
- 🏛 기반 연구: [[papers/1015_S2ORC_The_Semantic_Scholar_Open_Research_Corpus/review]] — Semantic Scholar의 대규모 연구 말뭉치가 30년 종단 scientometric 데이터셋 구축의 기술적 기반과 참고 모델을 제공합니다.
- 🔄 다른 접근: [[papers/993_OpenAlex_A_fully-open_index_of_scholarly_works_authors_venue/review]] — 학술 연구의 대규모 데이터셋 구축에서 arXiv 중심의 SciEvo와 포괄적 OpenAlex라는 서로 다른 접근법을 비교할 수 있습니다.
- 🧪 응용 사례: [[papers/972_Identifying_interdisciplinary_emergence_in_the_science_of_sc/review]] — 과학의 과학에서 학제 간 출현을 식별하는 데 30년간의 종단 scientometric 데이터셋을 구체적으로 적용할 수 있습니다.
- 🏛 기반 연구: [[papers/1170_Evolution_of_Social_Work_Knowledge_Production_Over_35_Years/review]] — 35년간 사회복지 지식생산 진화 분석에서 대규모 학제간 데이터셋의 종단 분석 방법론을 활용할 수 있다.
