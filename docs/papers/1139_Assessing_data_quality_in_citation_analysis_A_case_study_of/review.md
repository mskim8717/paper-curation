...
- 🏛 기반 연구: [[papers/1115_Google_Scholar_Microsoft_Academic_Scopus_Dimensions_Web_of_S/review]] — 다양한 학술 데이터베이스의 비교 분석이 Web of Science와 Crossref의 데이터 품질 평가를 위한 기준을 제공한다.
- 🔗 후속 연구: [[papers/1053_Visualizing_the_context_of_citations_referencing_papers_publ/review]] — 인용 분석의 데이터 품질 평가가 인용 맥락 시각화 방법론의 신뢰성을 확보하는 데 필수적이다.
- 🔄 다른 접근: [[papers/992_OpenAlex_in_focus_Metadata_quality_of_publication_type_and_l/review]] — OpenAlex와 Web of Science/Crossref 모두 학술 메타데이터 품질 평가의 서로 다른 접근법을 제시한다.
- 🏛 기반 연구: [[papers/1009_Relative_Citation_Ratio_A_New_Metric_That_Uses_Citation_Rate/review]] — 인용 분석에서 데이터 품질 평가가 RCR과 같은 새로운 인용 지표의 신뢰성을 보장하는 기반을 제공합니다.
- 🏛 기반 연구: [[papers/1115_Google_Scholar_Microsoft_Academic_Scopus_Dimensions_Web_of_S/review]] — 인용 분석에서 데이터 품질 평가의 중요성과 방법론적 기반을 제공한다.
- 🏛 기반 연구: [[papers/1053_Visualizing_the_context_of_citations_referencing_papers_publ/review]] — 인용 데이터의 품질 평가가 인용 맥락 분석의 신뢰성을 확보하는 데 필수적인 기반을 제공한다.
- 🔗 후속 연구: [[papers/943_Citation_Analysis_as_a_Tool_in_Journal_Evaluation/review]] — 인용 분석의 데이터 품질 평가를 통해 저널 평가 도구의 신뢰성을 향상시킨다
- 🏛 기반 연구: [[papers/1157_Critical_Review_with_Scientometrics_Approach_on_the_Retrofit/review]] — 인용 분석의 데이터 품질 평가 방법론이 LLM 기반 논문 검토의 기준이 됨
- 🔗 후속 연구: [[papers/1138_Arts_and_Humanities_Citation_Index_for_Research_Evaluation_i/review]] — A&HCI의 데이터 품질 문제를 인용 분석에서 일반적인 데이터 품질 평가 문제로 확장하여 분석합니다.
