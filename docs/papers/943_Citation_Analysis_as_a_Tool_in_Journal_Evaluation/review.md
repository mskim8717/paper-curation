...
- 🏛 기반 연구: [[papers/1218_Viewing_Citation_Analysis_Through_the_Lens_of_Citation_Justi/review]] — 저널 평가를 위한 인용 분석 도구 개발은 citation justice 관점에서 인용 분석을 재검토하는 연구의 기초적 배경을 제공한다.
- 🔗 후속 연구: [[papers/1081_Science_Citation_IndexA_New_Dimension_in_Indexing_This_uniqu/review]] — 저널 평가용 인용 분석 연구는 새로운 차원의 인덱싱 시스템인 Science Citation Index의 실제 응용 사례를 보여준다.
- 🧪 응용 사례: [[papers/1081_Science_Citation_IndexA_New_Dimension_in_Indexing_This_uniqu/review]] — 인용 분석을 저널 평가 도구로 활용하는 구체적 방법론을 제시하여 인용 색인의 실용적 가치를 보여준다.
- 🏛 기반 연구: [[papers/1218_Viewing_Citation_Analysis_Through_the_Lens_of_Citation_Justi/review]] — 인용 정의를 실현하기 위해 저널 평가에서 인용 분석의 근본적 원리와 한계를 이해할 필요가 있음
- 🏛 기반 연구: [[papers/1151_Citation_Analysis_of_DESIDOC_Journal_of_Information_Technolo/review]] — DJLIT 인용 분석의 방법론적 기반을 확립하기 위해 저널 평가에서 인용 분석의 근본 원리를 이해할 필요가 있음
