...
- ⚖️ 반론/비판: [[papers/1021_Scientific_production_in_the_era_of_large_language_models/review]] — 오픈 언어 모델 연구 촉진과 LLM 시대 과학 출판의 우려 사이의 대조적 관점임
- 🏛 기반 연구: [[papers/925_1500_scientists_lift_the_lid_on_reproducibility/review]] — 과학 재현성 위기가 완전 공개 언어 모델 개발의 필요성을 뒷받침함
- 🏛 기반 연구: [[papers/1033_The_Empowerment_of_Science_of_Science_by_Large_Language_Mode/review]] — LLM의 과학 연구 영향력 분석에 필요한 오픈 모델 인프라를 제공함
- 🏛 기반 연구: [[papers/1051_Unsupervised_Word_Embeddings_Capture_Latent_Knowledge_from_M/review]] — 공개된 언어 모델 연구를 통해 재료과학 임베딩의 메커니즘을 더 잘 이해할 수 있음
