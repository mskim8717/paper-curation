...
- 🔄 다른 접근: [[papers/1109_A_comprehensive_large-scale_biomedical_knowledge_graph_for_A/review]] — 생의학 과학 지도와 대규모 생의학 지식 그래프를 결합하여 더욱 포괄적인 생의학 연구 생태계를 구축할 수 있음
- 🧪 응용 사례: [[papers/1073_MOLIERE_Automatic_Biomedical_Hypothesis_Generation_System/review]] — 생의학 과학 지도의 구조를 바탕으로 자동 가설 생성 시스템의 도메인 특화 성능을 개선할 수 있음
- 🔗 후속 연구: [[papers/1051_Unsupervised_Word_Embeddings_Capture_Latent_Knowledge_from_M/review]] — 생의학 과학 지도 구축 방법론을 재료과학 도메인에 적용하여 더 포괄적인 과학 지식 구조 분석이 가능하다.
