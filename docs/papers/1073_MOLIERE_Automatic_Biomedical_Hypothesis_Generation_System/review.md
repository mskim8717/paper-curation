...
- 🔗 후속 연구: [[papers/1109_A_comprehensive_large-scale_biomedical_knowledge_graph_for_A/review]] — 생의학 가설 생성에서 MEDLINE 기반 접근법을 더 포괄적인 지식그래프로 발전시킴
- 🏛 기반 연구: [[papers/978_Introducing_the_open_biomedical_map_of_science/review]] — 오픈 생의학 과학 지도가 자동 가설 생성 시스템의 이론적 기반을 제공함
- 🔄 다른 접근: [[papers/1116_Harnessing_the_Power_of_Adversarial_Prompting_and_Large_Lang/review]] — 가설 생성에서 생의학 네트워크 기반과 LLM 기반의 다른 접근법임
- 🔗 후속 연구: [[papers/1109_A_comprehensive_large-scale_biomedical_knowledge_graph_for_A/review]] — 생의학 가설 생성을 MEDLINE 네트워크에서 포괄적 지식그래프로 발전시킴
- 🔄 다른 접근: [[papers/1116_Harnessing_the_Power_of_Adversarial_Prompting_and_Large_Lang/review]] — 가설 생성에서 LLM 기반 프롬프팅과 생의학 네트워크 기반의 다른 접근법임
- 🏛 기반 연구: [[papers/1118_Paper_Circle_An_Open-source_Multi-agent_Research_Discovery_a/review]] — MOLIERE의 자동 생물의학 가설 생성 시스템이 Paper Circle의 다중 에이전트 연구 발견 접근법의 선행 모델이다.
