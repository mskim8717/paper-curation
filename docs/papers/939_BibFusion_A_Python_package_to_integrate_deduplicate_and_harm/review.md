...
- 🔄 다른 접근: [[papers/1024_Software_survey_VOSviewer_a_computer_program_for_bibliometri/review]] — BibFusion의 Python 기반 서지데이터 통합 도구와 VOSviewer의 시각화 중심 서지계량 분석 도구가 상호 보완적인 대안을 제시합니다.
- 🏛 기반 연구: [[papers/1015_S2ORC_The_Semantic_Scholar_Open_Research_Corpus/review]] — Scopus와 Web of Science 데이터 통합을 위해서는 S2ORC와 같은 대규모 오픈 연구 코퍼스가 제공하는 기반 구조가 필요합니다.
