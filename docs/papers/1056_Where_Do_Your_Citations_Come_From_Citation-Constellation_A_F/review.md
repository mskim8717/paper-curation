...
- 🏛 기반 연구: [[papers/1053_Visualizing_the_context_of_citations_referencing_papers_publ/review]] — 논문 인용 맥락의 시각화가 인용 네트워크의 사회구조적 경로를 분석하는 Citation-Constellation 도구의 기반을 제공합니다.
- 🔄 다른 접근: [[papers/1009_Relative_Citation_Ratio_A_New_Metric_That_Uses_Citation_Rate/review]] — 인용 프로필 분석에서 사회구조적 경로 분해와 공동인용 기반 상대인용비율이라는 서로 다른 측정 접근법을 제시합니다.
- 🏛 기반 연구: [[papers/944_Co-Citation_Analysis_Bibliographic_Coupling_and_Direct_Citat/review]] — 공동인용 분석과 서지학적 결합의 기본 원리가 인용 네트워크의 사회구조적 분석을 위한 방법론적 기반을 제공합니다.
- 🔄 다른 접근: [[papers/1009_Relative_Citation_Ratio_A_New_Metric_That_Uses_Citation_Rate/review]] — 논문 영향력 측정에서 공동인용 기반 정규화와 인용 네트워크의 사회구조적 경로 분석이라는 서로 다른 접근법을 제시합니다.
- 🔗 후속 연구: [[papers/1053_Visualizing_the_context_of_citations_referencing_papers_publ/review]] — Citation-Constellation 방법론이 인용 맥락 기반 키워드 네트워크 분석을 더욱 발전시킨 접근법이다.
- 🔗 후속 연구: [[papers/984_Mapping_Scholarly_Impact_Citation_Analysis_of_Commerce_Docto/review]] — 상업 박사논문의 학술적 임팩트 매핑 연구에 인용 출처 추적을 위한 Citation-Constellation 방법론이 유용한 확장을 제공합니다.
