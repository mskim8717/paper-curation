...
- 🔗 후속 연구: [[papers/1009_Relative_Citation_Ratio_A_New_Metric_That_Uses_Citation_Rate/review]] — Citation-Constellation은 RCR의 공동인용 기반 정규화를 인용 네트워크의 사회구조적 분석으로 확장한다.
- 🏛 기반 연구: [[papers/944_Co-Citation_Analysis_Bibliographic_Coupling_and_Direct_Citat/review]] — 공동인용 분석과 서지결합의 기본 원리는 인용 네트워크 경로 분석의 이론적 기반을 제공한다.
- 🔄 다른 접근: [[papers/1053_Visualizing_the_context_of_citations_referencing_papers_publ/review]] — 인용 맥락 시각화는 인용 네트워크 경로와 다른 방식으로 인용 구조를 분석하는 접근법을 제시한다.
- 🔗 후속 연구: [[papers/1009_Relative_Citation_Ratio_A_New_Metric_That_Uses_Citation_Rate/review]] — Citation-Constellation의 인용 네트워크 분석은 RCR의 공동인용 기반 정규화를 보완하는 사회구조적 관점을 제공한다.
- 🔗 후속 연구: [[papers/1053_Visualizing_the_context_of_citations_referencing_papers_publ/review]] — 단순 인용 맥락 분석을 넘어서 인용의 출처와 확산 패턴까지 추적하는 더 포괄적인 분석 방법입니다.
