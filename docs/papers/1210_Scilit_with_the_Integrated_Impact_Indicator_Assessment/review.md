...
- 🔄 다른 접근: [[papers/1009_Relative_Citation_Ratio_A_New_Metric_That_Uses_Citation_Rate/review]] — Relative Citation Ratio와 I3/I3N 지표가 모두 학제간 저널 평가에서 기존 지표의 한계를 극복하려는 대안적 접근이다.
- 🏛 기반 연구: [[papers/1047_Theory_and_Practice_of_the_g-index/review]] — g-index와 같은 기존 영향력 지표의 이론과 실무를 바탕으로 새로운 통합 지표를 개발했다.
- 🧪 응용 사례: [[papers/1008_Reinforcing_Prestige_Journal_Citation_Biases_in_Astronomy/review]] — 새로운 영향력 지표가 천문학 분야의 저널 인용 편향 문제 해결에 적용될 수 있다.
