...
- 🏛 기반 연구: [[papers/1112_CS-KG_20_A_Large-scale_Knowledge_Graph_of_Computer_Science/review]] — 컴퓨터과학 지식그래프가 AI 교육용 지식그래프 구축의 기반 데이터를 제공함
- 🔄 다른 접근: [[papers/1072_Embracing_Foundation_Models_for_Advancing_Scientific_Discove/review]] — 과학 발견과 교육에서 기초 모델 활용의 다른 접근법과 목적을 보여줌
- 🔄 다른 접근: [[papers/1170_Evolution_of_Social_Work_Knowledge_Production_Over_35_Years/review]] — 지식 생산 분석에서 AI 교육과 사회복지학의 다른 학문 영역 접근법임
- 🔗 후속 연구: [[papers/1112_CS-KG_20_A_Large-scale_Knowledge_Graph_of_Computer_Science/review]] — 컴퓨터과학 지식그래프가 AI 교육용 지식그래프 구축의 기반 데이터가 됨
- 🔗 후속 연구: [[papers/1179_Global_Research_Trends_in_Knowledge_Management_in_Higher_Edu/review]] — AI 시대 학생 학습 경로 향상 연구를 고등교육기관의 지식관리 맥락으로 확장하여 교육혁신의 제도적 접근을 탐구한다.
