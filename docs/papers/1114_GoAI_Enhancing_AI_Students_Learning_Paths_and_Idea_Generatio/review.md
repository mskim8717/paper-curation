...
- 🔄 다른 접근: [[papers/1072_Embracing_Foundation_Models_for_Advancing_Scientific_Discove/review]] — GoAI의 교육용 지식그래프와 KG-CoI의 과학 발견용 지식그래프는 서로 다른 목적으로 AI 연구 지원을 제공하는 상호 보완적 시스템이다.
- 🔗 후속 연구: [[papers/1175_Figures_as_Interfaces_Toward_LLM-Native_Artifacts_for_Scient/review]] — LLM 네이티브 과학 커뮤니케이션 아티팩트가 GoAI의 개인화된 학습 경로와 통합되어 더 효과적인 AI 교육 환경을 구축할 수 있다.
